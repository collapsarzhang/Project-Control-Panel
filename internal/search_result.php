...
// Define the query:
$q = "SELECT * FROM dean_poll_projects WHERE id > ".$search_id.$query_term." ORDER BY id DESC LIMIT ".$display;
$r = mysql_query ($q); // Run the query.
				...
				<div class="box">
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<th align="left" style="width:10%">ID</th>
								<th align="left" style="width:45%">Name</th>
