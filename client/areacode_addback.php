...
$q = "UPDATE dialout_numbers SET result='' WHERE attempts=0 AND result='removed' AND prov!='TEST' AND SUBSTRING(phonenumber,1,3)=".$areacode." AND projectid=".$id;
$result = mysql_query($q);
$logging = "Addback Areacode ".$areacode." for Project ".$id;
