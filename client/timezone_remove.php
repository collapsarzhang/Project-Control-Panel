...
$q = "UPDATE dialout_numbers SET result='removed', active=0 WHERE attempts=0 AND (result is NULL OR result='') AND prov!='TEST' AND timezone=".$timezone." AND projectid=".$id;
$result = mysql_query($q);
$logging = "Remove Timezone ".$timezone." for Project ".$id;
