...
if (isset($_POST['user_id']) && isset($_POST['pass'])) {
	...
	if (isset($consultants[$_POST['user_id']]) && $consultants[$_POST['user_id']]['password'] == $_POST['pass']) {
		$_SESSION['user_ivr_fndp'] = $_POST['user_id'];
		$open = fopen("logs/".date("Y_m_d").".log","a+");
		$text = $_SESSION['user_ivr_fndp']." has logged in at ".date("F jS, Y @G:i")."\r\n";
		fwrite($open, $text);
		fclose($open);
		$match = true;
		$con = dbc_ivr();
		$r = mysql_query("INSERT INTO log (userid, action) VALUES ('".$_SESSION['user_ivr_fndp']."', 'Successful Login')");
		mysql_close($con);
	}
}
...
if (!isset($_SESSION['user_ivr_fndp'])) {
	...
	else if (isset($_POST['page']) && $_POST['page']=='edit_project')
		include "edit_project.php";
	else if (isset($_POST['page']) && $_POST['page']=='clone_project')
		include "clone_project.php";
	else if (isset($_GET['page']) && $_GET['page']=='add_project')
		include "add_project.php";
	else if (isset($_POST['page']) && $_POST['page']=='project_action')
		include "project_action.php";
	else if (isset($_POST['page']) && $_POST['page']=='number_analysis')
		include "number_analysis.php";
	else if (isset($_GET['page']) && $_GET['page']=='upload_dnc')
		include "upload_dnc.php";
	else if (isset($_POST['page']) && $_POST['page']=='send_testing')
		include "send_testing.php";
	else if (isset($_POST['page']) && $_POST['page']=='upload_dnc_post')
		include "upload_dnc_post.php";
	else if (isset($_POST['page']) && $_POST['page']=='edit_project_post')
		include "edit_project_post.php";
	else if (isset($_POST['page']) && $_POST['page']=='edit_project_status_post')
		include "edit_project_status_post.php";
	...
	else if (isset($_POST['page']) && $_POST['page']=='add_dnc_post')
		include "add_remove_dnc_number.php";
	else if (isset($_POST['page']) && $_POST['page']=='remove_dnc_post')
		include "add_remove_dnc_number.php";
