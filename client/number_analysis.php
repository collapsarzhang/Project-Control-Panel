		...
		<div id="main">
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<!-- End Box Head-->
					<?php
					$q = "SELECT COUNT(*) FROM dialout_numbers WHERE result='invalid' AND prov!='TEST' AND projectid=".$id;
					$r = mysql_query($q);
					$row = mysql_fetch_array($r);
					$number_of_invalid_records = $row[0];
					?>
					<div class="box-content">
						<div><a href="javascript:void(0)" onclick="submitForm('index.php','edit_project','edit_project',<?php echo $id; ?>)" class="add-button"><span>Return to Project Panel</span></a></div>
						<p>&nbsp;<p>
						<div><a href="javascript:void(0)" onclick="submitForm('download_invalid.php','download_invalid','download_invalid',<?php echo $id; ?>)" class="add-button"><span>Download Invalid Numbers</span></a></div>
						<p>&nbsp;<p>
						<div><span>There are total of <?php echo $number_of_invalid_records; ?> invalid numbers</span></div>
						<div class="cl">&nbsp;</div>					
					</div>
